...
<!--        <h1>الصفحه الرئيسيه</h1>-->
        ...
        <?php // Html::a('اضف سيارتك', ['addcar'], ['class'=>'btn btn-primary']) ?>
        
        <?php // Html::a('الصفحه الشخصيه', ['editprofile'], ['class'=>'btn btn-primary']) ?>
...
<section class="main-slider" style="direction: ltr;text-align: left;">
			...
			<ul>	<!-- SLIDE  -->
				...
				data-description="">
					...
					<a  href="<?= Url::toRoute(['/site/registration']) ?>"
						...
						style="z-index: 5; font-size: 22px; line-height: 50px; font-weight: 700; color: rgba(255,255,255,1); letter-spacing: 2px;font-family:Roboto Condensed;border-color:rgb(255,255,255);border-style:solid;border-width:1px 1px 1px 1px;outline:none;box-shadow:none;cursor:pointer;text-align:center">أبدا الان</a>
					...
					<div class="tp-caption   tp-resizeme" 
						...
						style="z-index: 7; white-space: normal; font-size: 20px; line-height: 20px; font-weight: 800; color: #ffffff; letter-spacing: 10px;font-family:Roboto Condensed;">تبادل</div>
					...
					<div class="tp-caption   tp-resizeme" 
						...
						style="z-index: 8; min-width: 650px; max-width: 650px; white-space: normal; font-size: 70px; line-height: 70px; font-weight: 700; color: #ffffff; letter-spacing: -2px;font-family:Playfair Display;">أحصل علي سياره كل يوم </div>
				</li>
				<!-- SLIDE  -->
				<li data-index="rs-74" 
					data-transition="fade" 
					...
					<!-- LAYER NR. 6 -->
					<a 	
						href="<?= Url::toRoute(['/site/registration']) ?>"
						class="tp-caption rev-btn  tp-resizeme" 
						data-x="['left','left','left','left']"
						...
						style="z-index: 6; white-space: normal; font-size: 22px; line-height: 50px; font-weight: 400; color: rgba(255,255,255,1); letter-spacing: 2px;font-family:Roboto Condensed;border-color:rgb(255,255,255);border-style:solid;border-width:1px 1px 1px 1px;outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;cursor:pointer;">انضم لنا</a>
					...
					<div class="tp-caption   tp-resizeme" 
						...
						style="z-index: 8; min-width: 650px; max-width: 650px; white-space: normal; font-size: 70px; line-height: 70px; font-weight: 400; color: #ffffff; letter-spacing: -2px;font-family:Playfair Display;">قم بتبديل سيارتك و استمتع بمظهر جديد
					</div>
				</li>
				<!-- SLIDE  -->
				<li data-index="rs-75" 
					...
					<div class="tp-caption   tp-resizeme" 
						...
						style="z-index: 6; min-width: 650px; max-width: 650px; white-space: normal; font-size: 70px; line-height: 70px; font-weight: 400; color: #ffffff; letter-spacing: -2px;font-family:Playfair Display;">جرب السيارة التي تريدها قبل شراءها</div>
					...
					<div class="tp-caption rev-btn  tp-resizeme" 
						...
						data-textAlign="['center','center','center','center']"
						data-paddingtop="[6,6,6,6]"
						style="z-index: 8; white-space: normal; font-size: 22px; line-height: 50px; font-weight: 400; color: rgba(255,255,255,1); letter-spacing: 2px;font-family:Roboto Condensed;border-color:rgb(255,255,255);border-style:solid;border-width:1px 1px 1px 1px;outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;cursor:pointer;text-align:center!important;">اشترك الان 
					</div>
				</li>
			</ul>
